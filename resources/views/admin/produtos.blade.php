...
<div class="fixed-action-btn">
    ...
    <div class="row container crud">
           ...
           <nav class="bg-gradient-blue">
            ...
            @include('admin.includs.mensagem')
            <table class="striped ">
                <thead>
                  <tr>
                    <th></th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a class="btn-floating modal-trigger  waves-effect waves-light orange"><i class="material-icons">mode_edit</i></a>

                      <a href="#delete-{{$produto->id}}" class="btn-floating  waves-effect waves-light red"><i class="material-icons">delete</i></a></td>
